package com.ftn.udd.elasticsearch.config;
...
import com.ftn.udd.elasticsearch.plugin.SerbianPlugin;

@Configuration
@EnableElasticsearchRepositories(basePackages = "com.ftn.udd.elasticsearch.repository")
public class ElasticsearchConfiguration {
    ...
    public Client nodeClient() {
        ...
        Settings settings = Settings.builder()
                ...
                .put("cluster.name", "itCompanyNode")
